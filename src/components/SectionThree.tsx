    ...
    return (
        <motion.section id={dict.id} variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="w-full max-w-screen min-h-screen flex flex-col gap-10 py-20">
            ...
            <div className="relative w-full group">
                ...
                <motion.div className="flex items-stretch overflow-x-auto scrollbar-hide px-10 py-10 snap-x snap-mandatory gap-10 mask-linear" style={{ maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)' }}>
