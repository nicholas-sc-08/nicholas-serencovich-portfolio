...
export default function SectionThree({ dict }: SectionThreeProps) {
    return (
        <motion.section
            ...
            className="w-full max-w-screen min-h-screen flex flex-col gap-10 py-20"
        >
            {/* Título com padding lateral para alinhar com os cards */}
            <div className="px-10">
            ...
            {/* Container Relativo para criar o efeito de gradiente nas bordas */}
            <div className="relative w-full group">

                {/* Gradiente de Mascaramento Esquerdo */}
                <div className="absolute left-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-r from-background to-transparent pointer-events-none" />
                <motion.div className="flex items-stretch overflow-x-auto scrollbar-hide px-10 py-10 snap-x snap-mandatory cursor-grab active:cursor-grabbing gap-10 mask-linear"
