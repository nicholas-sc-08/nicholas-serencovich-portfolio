...
export default function SectionFour({ dict }: SectionFourProps) {
    return (
        <motion.section className="p-10 bg-secondary md:text-start text-center grid md:grid-cols-2 grid-cols-1 gap-15" variants={containerVariants} initial="hidden" whileInView={"visible"} viewport={{ once: true, amount: 0.3 }}>
            ...
            <div className="flex flex-col gap-10 font-semibold text-2xl">
                <motion.h4>{dict.groupSkillOne}</motion.h4>
